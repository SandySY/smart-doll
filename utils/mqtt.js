  ...
  return function e(t, r, n) {
    ...
    1: [function(t, r, n) {
      (function(n, i) {
        var o = t("events"),
          s = t("./store"),
          a = t("mqtt-packet"),
          u = t("readable-stream").Writable,
          c = t("inherits"),
          l = t("reinterval"),
          f = t("./validations"),
          h = t("xtend"),
          p = i.setImmediate || function(e) {
            n.nextTick(e)
          },
          d = {
            keepalive: 60,
        ...
        function v(e, t) {
          ...
          this.options.clientId = "string" == typeof t.clientId ? t.clientId : "mqttjs_" + Math.random().toString(16).substr(2, 8), this.options.customHandleAcks = 5 === t.protocolVersion && t.customHandleAcks ? t.customHandleAcks : function() {
            arguments[3](0)
          }, this.streamBuilder = e, this.outgoingStore = t.outgoingStore || new s, this.incomingStore = t.incomingStore || new s, this.queueQoSZero = void 0 === t.queueQoSZero || t.queueQoSZero, this._resubscribeTopics = {}, this.messageIdToTopic = {}, this.pingTimer = null, this.connected = !1, this.disconnecting = !1, this.queue = [], this.connackTimer = null, this.reconnectTimer = null, this._storeProcessing = !1, this._packetIdsDuringStoreProcessing = {}, this.nextId = Math.max(1, Math.floor(65535 * Math.random())), this.outgoing = {}, this._firstConnection = !0, this.on("close", (function() {
        ...
        c(v, o.EventEmitter), v.prototype._setupStream = function() {
          ...
          if (this._clearReconnect(), this.stream = this.streamBuilder(this), o.on("packet", (function(e) {
              ...
              var e;
              (e = r.outgoing) && Object.keys(e).forEach((function(t) {
                e[t].volatile && "function" == typeof e[t].cb && (e[t].cb(new Error("Connection closed")), delete e[t])
              })), r.emit("close")
            })), (t = Object.create(this.options)).cmd = "connect", b(this, t), o.on("error", this.emit.bind(this, "error")), this.options.properties) {
        ...
        }, v.prototype.pingreq = function(e, t, r, n) {
          this._cleanUp(!0)
          ...
          if (delete o.resubscribe, "string" == typeof o && (o = [o]), "function" != typeof a && (u = a, a = m), null !== (n = f.validateTopics(o))) return p(a, new Error("Invalid topic " + n)), this;
          ...
          if (5 === l && (d.nl = !1, d.rap = !1, d.rh = 0), u = h(d, u), Array.isArray(o) ? o.forEach((function(e) {
              if (!c._resubscribeTopics.hasOwnProperty(e) || c._resubscribeTopics[e].qos < u.qos || s) {
                ...
                5 === l && (t.nl = u.nl, t.rap = u.rap, t.rh = u.rh, t.properties = u.properties), i.push(t)
              }
              ...
              if (!c._resubscribeTopics.hasOwnProperty(e) || c._resubscribeTopics[e].qos < o[e].qos || s) {
                ...
                5 === l && (t.nl = o[e].nl, t.rap = o[e].rap, t.rh = o[e].rh, t.properties = u.properties), i.push(t)
              }
            })), e = {
              cmd: "subscribe",
              subscriptions: i,
            ...
            if (this.options.resubscribe) {
              ...
              i.forEach((function(e) {
                if (c.options.reconnectPeriod > 0) {
                  ...
                  5 === l && (t.nl = e.nl || !1, t.rap = e.rap || !1, t.rh = e.rh || 0, t.properties = e.properties), c._resubscribeTopics[e.topic] = t, g.push(e.topic)
                }
          ...
          var o = n.shift(),
            s = n.pop() || m,
            a = n.pop();
          return "string" == typeof o && (o = [o]), "function" != typeof s && (a = s, s = m), this._checkDisconnecting(s) || ("string" == typeof o ? t.unsubscriptions = [o] : "object" === e(o) && o.length && (t.unsubscriptions = o), this.options.resubscribe && t.unsubscriptions.forEach((function(e) {
            delete r._resubscribeTopics[e]
          })), "object" === e(a) && a.properties && (t.properties = a.properties), this.outgoing[t.messageId] = {
            volatile: !0,
            cb: s
          ...
          return null != r && "boolean" == typeof r || (i = n || m, n = r, r = !1, "object" !== e(n) && (i = n, n = null, "function" != typeof i && (i = m))), "object" !== e(n) && (i = n, n = null), i = i || m, this.disconnecting || (this._clearReconnect(), this.disconnecting = !0, !r && Object.keys(this.outgoing).length > 0 ? this.once("outgoingEmpty", setTimeout.bind(null, s, 10)) : s()), this
          ...
          var t = this,
            r = function() {
              e ? (t.options.incomingStore = e.incomingStore, t.options.outgoingStore = e.outgoingStore) : (t.options.incomingStore = null, t.options.outgoingStore = null), t.incomingStore = t.options.incomingStore || new s, t.outgoingStore = t.options.outgoingStore || new s, t.disconnecting = !1, t.disconnected = !1, t._deferredReconnect = null, t._reconnect()
            };
          ...
          var r = arguments[2];
          if (t && this.stream.on("close", t), e) 0 === this.options.reconnectPeriod && this.options.clean && y(this.outgoing), this.stream.destroy();
          else {
            var n = h({
              cmd: "disconnect"
            }, r);
          ...
          if (o) {
            switch (n) {
              ...
              case "puback":
                var a = e.reasonCode;
                a && a > 0 && 16 !== a && ((t = new Error("Publish error: " + g[a])).code = a, o(t, e)), delete this.outgoing[r], this.outgoingStore.del(e, o);
                break;
              case "pubrec":
                i = {
                  cmd: "pubrel",
      ...
      (function(n) {
        ...
        function c(t, r) {
          ...
          if (function(e) {
            ...
            }(r), r.query && "string" == typeof r.query.clientId && (r.clientId = r.query.clientId), r.cert && r.key) {
          ...
          return r.protocol && (r.defaultProtocol = r.protocol), new i((function(e) {
            return r.servers && (e._reconnectCount && e._reconnectCount !== r.servers.length || (e._reconnectCount = 0), r.host = r.servers[e._reconnectCount].host, r.port = r.servers[e._reconnectCount].port, r.protocol = r.servers[e._reconnectCount].protocol ? r.servers[e._reconnectCount].protocol : r.defaultProtocol, r.hostname = r.host, e._reconnectCount++), u[r.protocol](e, r)
          }), r)
        }
        "browser" !== n.title ? (u.mqtt = t("./tcp"), u.tcp = t("./tcp"), u.ssl = t("./tls"), u.tls = t("./tls"), u.mqtts = t("./tls")) : (u.wx = t("./wx"), u.wxs = t("./wx"), u.ali = t("./ali"), u.alis = t("./ali")), u.ws = t("./ws"), u.wss = t("./ws"), r.exports = c, r.exports.connect = c, r.exports.MqttClient = i, r.exports.Store = o
    ...
    10: [function(e, t, r) {
      r.byteLength = function(e) {
        ...
        for (var t, r = c(e), n = r[0], s = r[1], a = new o(function(e, t, r) {
            return 3 * (t + r) / 4 - r
          }(0, n, s)), u = 0, l = s > 0 ? n - 4 : n, f = 0; f < l; f += 4) t = i[e.charCodeAt(f)] << 18 | i[e.charCodeAt(f + 1)] << 12 | i[e.charCodeAt(f + 2)] << 6 | i[e.charCodeAt(f + 3)], a[u++] = t >> 16 & 255, a[u++] = t >> 8 & 255, a[u++] = 255 & t;
    ...
    12: [function(t, r, n) {
      ...
      n.kMaxLength = 2147483647, a.TYPED_ARRAY_SUPPORT = function() {
        ...
        if (D(e, Uint8Array) && (e = a.from(e, e.offset, e.byteLength)), D(t, Uint8Array) && (t = a.from(t, t.offset, t.byteLength)), !a.isBuffer(e) || !a.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
        if (e === t) return 0;
        ...
        if (r >= n) return 1;
        if (this === t) return 0;
        for (var s = (o >>>= 0) - (i >>>= 0), u = (n >>>= 0) - (r >>>= 0), c = Math.min(s, u), l = this.slice(i, o), f = t.slice(r, n), h = 0; h < c; ++h)
          if (l[h] !== f[h]) {
            s = l[h], u = f[h];
            break
    ...
    13: [function(t, r, n) {
      ...
      function h(e, t, r) {
        if (t) e.call(r);
          ...
          for (var n = e.length, i = S(e, n), o = 0; o < n; ++o) i[o].call(r)
      }

      function p(e, t, r, n) {
        if (t) e.call(r, n);
        else
          for (var i = e.length, o = S(e, i), s = 0; s < i; ++s) o[s].call(r, n)
      }

      function d(e, t, r, n, i) {
        if (t) e.call(r, n, i);
        else
          for (var o = e.length, s = S(e, o), a = 0; a < o; ++a) s[a].call(r, n, i)
      }

      function g(e, t, r, n, i, o) {
        if (t) e.call(r, n, i, o);
        else
          for (var s = e.length, a = S(e, s), u = 0; u < s; ++u) a[u].call(r, n, i, o)
      }

      function b(e, t, r, n) {
        if (t) e.apply(r, n);
        else
          for (var i = e.length, o = S(e, i), s = 0; s < i; ++s) o[s].apply(r, n)
      }

      function y(t, r, n, o) {
        var s, a, u;
        if ("function" != typeof n) throw new TypeError('"listener" argument must be a function');
        if ((a = t._events) ? (a.newListener && (t.emit("newListener", r, n.listener ? n.listener : n), a = t._events), u = a[r]) : (a = t._events = i(null), t._eventsCount = 0), u) {
          if ("function" == typeof u ? u = a[r] = o ? [n, u] : [u, n] : o ? u.unshift(n) : u.push(n), !u.warned && (s = f(t)) && s > 0 && u.length > s) {
            u.warned = !0;
            ...
            c.name = "MaxListenersExceededWarning", c.emitter = t, c.type = r, c.count = u.length, "object" === ("undefined" == typeof console ? "undefined" : e(console)) && console.warn && console.warn("%s: %s", c.name, c.message)
          }
    ...
    15: [function(e, t, r) {
      ...
      n = function(e, t, r) {
        ...
        return delete(n = i(t)).writable, delete n.value, n.get = function() {
          return !r.overwriteDefinition && h.call(this, e) ? o : (t.value = l.call(o, r.resolveContext ? r.resolveContext(this) : this), f(this, e, t), this[e])
        }, n
    ...
    16: [function(e, t, r) {
      ...
      (t.exports = function(e, t) {
        var r, o, a, u, c;
        return arguments.length < 2 || "string" != typeof e ? (u = t, t = e, e = null) : u = arguments[2], null == e ? (r = a = !0, o = !1) : (r = s.call(e, "c"), o = s.call(e, "e"), a = s.call(e, "w")), c = {
          value: t,
          configurable: r,
          enumerable: o,
          writable: a
        ...
        var a, u, c, l;
        return "string" != typeof e ? (c = r, r = t, t = e, e = null) : c = arguments[3], null == t ? t = void 0 : o(t) ? null == r ? r = void 0 : o(r) || (c = r, r = void 0) : (c = t, t = r = void 0), null == e ? (a = !0, u = !1) : (a = s.call(e, "c"), u = s.call(e, "e")), l = {
          get: t,
          set: r,
          configurable: a,
          enumerable: u
    ...
    18: [function(e, t, r) {
      ...
      t.exports = function e(t, r, o) {
        ...
        return ! function(e) {
          ...
          }(t) ? c && !s && (t.on("end", l), t.on("close", l)) : (t.on("complete", f), t.on("abort", g), t.req ? b() : t.on("request", b)),
          function(e) {
            return e.stdio && Array.isArray(e.stdio) && 3 === e.stdio.length
          }(t) && t.on("exit", p), t.on("end", h), t.on("finish", f), !1 !== r.error && t.on("error", d), t.on("close", g),
          function() {
            t.removeListener("complete", f), t.removeListener("abort", g), t.removeListener("request", b), t.req && t.req.removeListener("finish", f), t.removeListener("end", l), t.removeListener("close", l), t.removeListener("finish", f), t.removeListener("exit", p), t.removeListener("end", h), t.removeListener("error", d), t.removeListener("close", g)
          }
      }
    }, {
      once: 90
    ...
    20: [function(e, t, r) {
      ...
      t.exports = function(e) {
        ...
        for (r = i(o(this).length), l = arguments[1], t = l = isNaN(l) ? 0 : l >= 0 ? c(l) : i(this.length) - c(u(l)); t < r; ++t)
    ...
    23: [function(e, t, r) {
      ...
      t.exports = function(e) {
        var t, r, g, b, y, _, m, v, w, S, x = arguments[1],
          E = arguments[2];
        if (e = Object(u(e)), c(x) && a(x), this && this !== Array && o(this)) t = this;
        else {
          if (!x) {
            if (i(e)) return 1 !== (y = e.length) ? Array.apply(null, e) : ((b = new Array(1))[0] = e[0], b);
            if (f(e)) {
        ...
        if (!f(e))
          if (void 0 !== (w = e[n])) {
            for (m = a(w).call(e), t && (b = new t), v = m.next(), r = 0; !v.done;) S = x ? h.call(x, E, v.value, r) : v.value, t ? (p.value = S, d(b, r, p)) : b[r] = S, v = m.next(), ++r;
            y = r
          } else if (l(e)) {
          for (y = e.length, t && (b = new t), r = 0, g = 0; r < y; ++r) S = e[r], r + 1 < y && (_ = S.charCodeAt(0)) >= 55296 && _ <= 56319 && (S += e[++r]), S = x ? h.call(x, E, S, g) : S, t ? (p.value = S, d(b, g, p)) : b[g] = S, ++g;
          y = g
        }
        if (void 0 === y)
          for (y = s(e.length), t && (b = new t(y)), r = 0; r < y; ++r) S = x ? h.call(x, E, e[r], r) : e[r], t ? (p.value = S, d(b, r, p)) : b[r] = S;
    ...
    35: [function(e, t, r) {
      ...
      t.exports = function(e, t) {
        return function(r, c) {
          var l, f = arguments[2],
            h = arguments[3];
          return r = Object(i(r)), n(c), l = a(r), h && l.sort("function" == typeof h ? o.call(h, r) : void 0), "function" != typeof e && (e = l[e]), s.call(e, l, (function(e, n) {
    ...
    53: [function(e, t, r) {
      ...
      n = function(e, t) {
        ...
        return e ? (2 === e.level ? e.set ? (r = e.set, t = function(e, t) {
          ...
          var i;
          return n(t, r), (i = s.call(e.nullPolyfill, t)) && delete e.nullPolyfill.__proto__, null === r && (r = e.nullPolyfill), t.__proto__ = r, i && a(e.nullPolyfill, "__proto__", u), t
    ...
    60: [function(e, t, r) {
      ...
      n = t.exports = function(e, t) {
        ...
        u.call(this, e), t = t ? o.call(t, "key+value") ? "key+value" : o.call(t, "key") ? "key" : "value" : "value", c(this, "__kind__", s("", t))
        ...
        if (a(e) || n(e) ? r = "array" : o(e) ? r = "string" : e = s(e), i(t), f = function() {
          ...
          if ("string" !== r)
            for (l = e.next(); !l.done;) {
              ...
              for (d = e.length, p = 0; p < d && (g = e[p], p + 1 < d && (b = g.charCodeAt(0)) >= 55296 && b <= 56319 && (g += e[++p]), u.call(t, y, g, f), !h); ++p);
    ...
    72: [function(e, t, r) {
      ...
      t.exports = n = function() {
        ...
        if (!(this instanceof n)) throw new TypeError("Constructor requires 'new'");
        return r = g && s && Map !== n ? s(new Map, _(this)) : this, null != i && h(i), y(r, {
    ...
    76: [function(t, r, n) {
      ...
      }))), h(o.prototype, o.toStringTag, u("c", "Symbol")), h(s.prototype, o.toStringTag, u("c", o.prototype[o.toStringTag])), h(s.prototype, o.toPrimitive, u("c", o.prototype[o.toPrimitive]))
    }, {
      "./validate-symbol": 77,
      d: 16
    }],
    ...
    78: [function(t, r, n) {
      ...
      o = function(e, t) {
        ...
        on: i = function(t, r) {
          var n;
          return h(r), _.call(this, "__ee__") ? n = this.__ee__ : (n = m.value = g(null), b(this, "__ee__", m), m.value = null), n[t] ? "object" === e(n[t]) ? n[t].push(r) : n[t] = [n[t], r] : n[t] = r, this
        },
        once: o,
        off: s = function(t, r) {
          var n, i, o, s;
          ...
          if (i = n[t], "object" === e(i))
            for (s = 0; o = i[s]; ++s) o !== r && o.__eeOnceListener__ !== r || (2 === i.length ? n[t] = i[s ? 0 : 1] : i.splice(s, 1));
          else i !== r && i.__eeOnceListener__ !== r || delete n[t];
          return this
        },
        emit: a = function(t) {
          var r, n, i, o, s;
          if (_.call(this, "__ee__") && (o = this.__ee__[t]))
            if ("object" === e(o)) {
    ...
    89: [function(t, r, n) {
      var i = t("./constants"),
        ...
        a = o.from([0]),
        u = t("./numbers"),
        c = t("process-nextick-args").nextTick,
        l = u.cache,
        f = u.generateNumber,
        h = u.generateCache,
        p = u.genBufVariableByteInt,
        d = u.generate4ByteBuffer,
        g = x,
        b = !0;
        ...
        switch (r.cork && (r.cork(), c(_, r)), b && (b = !1, h()), t.cmd) {
          case "connect":
            return function(t, r, n) {
              ...
              void 0 === l && (l = !0);
              var y = 0;
              if (!a || "string" != typeof a && !o.isBuffer(a)) return r.emit("error", new Error("Invalid protocolId")), !1;
              y += a.length + 2;
              if (3 !== u && 4 !== u && 5 !== u) return r.emit("error", new Error("Invalid protocol version")), !1;
              y += 1;
              if ("string" != typeof h && !o.isBuffer(h) || !h && 4 !== u || !h && !l) {
                if (u < 4) return r.emit("error", new Error("clientId must be supplied before 3.1.1")), !1;
                if (1 * l == 0) return r.emit("error", new Error("clientId must be given if cleanSession set to 0")), !1
              } else y += h.length + 2;
              if ("number" != typeof f || f < 0 || f > 65535 || f % 1 != 0) return r.emit("error", new Error("Invalid keepalive")), !1;
              y += 2;
              if (y += 1, 5 === u) {
                var _ = O(r, b);
                y += _.length
              ...
              if (c) {
                ...
                if (!c.topic || "string" != typeof c.topic) return r.emit("error", new Error("Invalid will topic")), !1;
                if (y += o.byteLength(c.topic) + 2, c.payload) {
                  if (!(c.payload.length >= 0)) return r.emit("error", new Error("Invalid will payload")), !1;
              ...
              if (null != d) {
                if (!S) return r.emit("error", new Error("Username is required to use password")), !1;
              ...
              var x = 0;
              x |= null != p ? i.USERNAME_MASK : 0, x |= null != d ? i.PASSWORD_MASK : 0, x |= c && c.retain ? i.WILL_RETAIN_MASK : 0, x |= c && c.qos ? c.qos << i.WILL_QOS_SHIFT : 0, x |= c ? i.WILL_FLAG_MASK : 0, x |= l ? i.CLEAN_SESSION_MASK : 0, r.write(o.from([x])), g(r, f), 5 === u && _.write();
          ...
          case "connack":
            return function(e, t, r) {
              var n = r ? r.protocolVersion : 4,
                s = e || {},
                u = 5 === n ? s.reasonCode : s.returnCode,
                c = s.properties,
                l = 2;
              if ("number" != typeof u) return t.emit("error", new Error("Invalid return code")), !1;
              var f = null;
              5 === n && (f = O(t, c), l += f.length);
              t.write(i.CONNACK_HEADER), v(t, l), t.write(s.sessionPresent ? i.SESSIONPRESENT_HEADER : a), t.write(o.from([u])), null != f && f.write();
              return !0
            }(t, r, n);
          case "publish":
            return function(e, t, r) {
              var n = r ? r.protocolVersion : 4,
                ...
                p = a.properties,
                d = 0;
              if ("string" == typeof l) d += o.byteLength(l) + 2;
              else {
                if (!o.isBuffer(l)) return t.emit("error", new Error("Invalid topic")), !1;
                d += l.length + 2
              }
              o.isBuffer(f) ? d += f.length : d += o.byteLength(f);
              if (u && "number" != typeof h) return t.emit("error", new Error("Invalid messageId")), !1;
              u && (d += 2);
              var b = null;
              5 === n && (b = O(t, p), d += b.length);
              t.write(i.PUBLISH_HEADER[u][a.dup ? 1 : 0][c ? 1 : 0]), v(t, d), g(t, A(l)), t.write(l), u > 0 && g(t, h);
              null != b && b.write();
              return t.write(f)
            }(t, r, n);
          case "puback":
          ...
          case "subscribe":
            return function(t, r, n) {
              var s = n ? n.protocolVersion : 4,
                a = t || {},
                u = a.dup ? i.DUP_MASK : 0,
                c = a.messageId,
                l = a.subscriptions,
                f = a.properties,
                h = 0;
              ...
              if ("object" !== e(l) || !l.length) return r.emit("error", new Error("Invalid subscriptions")), !1;
              for (var d = 0; d < l.length; d += 1) {
                var b = l[d].topic,
                  y = l[d].qos;
                if ("string" != typeof b) return r.emit("error", new Error("Invalid subscriptions - invalid topic")), !1;
                if ("number" != typeof y) return r.emit("error", new Error("Invalid subscriptions - invalid qos")), !1;
                if (5 === s) {
                  if ("boolean" != typeof(l[d].nl || !1)) return r.emit("error", new Error("Invalid subscriptions - invalid No Local")), !1;
                  if ("boolean" != typeof(l[d].rap || !1)) return r.emit("error", new Error("Invalid subscriptions - invalid Retain as Published")), !1;
                  var _ = l[d].rh || 0;
                  if ("number" != typeof _ || _ > 2) return r.emit("error", new Error("Invalid subscriptions - invalid Retain Handling")), !1
                }
              ...
              for (var m = !0, S = 0; S < l.length; S++) {
                var x, E = l[S],
                  ...
                  T = +E.rap,
                  A = E.rh;
                w(r, k), x = i.SUBSCRIBE_OPTIONS_QOS[I], 5 === s && (x |= j ? i.SUBSCRIBE_OPTIONS_NL : 0, x |= T ? i.SUBSCRIBE_OPTIONS_RAP : 0, x |= A ? i.SUBSCRIBE_OPTIONS_RH[A] : 0), m = r.write(o.from([x]))
              }
              return m
            }(t, r, n);
          case "suback":
            return function(t, r, n) {
              ...
              f += 2;
              if ("object" !== e(c) || !c.length) return r.emit("error", new Error("Invalid qos vector")), !1;
              for (var h = 0; h < c.length; h += 1) {
                if ("number" != typeof c[h]) return r.emit("error", new Error("Invalid qos vector")), !1;
                f += 1
              }
              var p = null;
              if (5 === s) {
          ...
          case "unsubscribe":
            return function(t, r, n) {
              var s = n ? n.protocolVersion : 4,
                a = t || {},
                u = a.messageId,
                c = a.dup ? i.DUP_MASK : 0,
                l = a.unsubscriptions,
                f = a.properties,
                h = 0;
              if ("number" != typeof u) return r.emit("error", new Error("Invalid messageId")), !1;
              h += 2;
              if ("object" !== e(l) || !l.length) return r.emit("error", new Error("Invalid unsubscriptions")), !1;
              for (var p = 0; p < l.length; p += 1) {
                if ("string" != typeof l[p]) return r.emit("error", new Error("Invalid unsubscriptions")), !1;
          ...
          case "unsuback":
            return function(t, r, n) {
              ...
              if ("number" != typeof u) return r.emit("error", new Error("Invalid messageId")), !1;
              if (5 === s) {
                if ("object" !== e(l) || !l.length) return r.emit("error", new Error("Invalid qos vector")), !1;
                for (var d = 0; d < l.length; d += 1) {
                  if ("number" != typeof l[d]) return r.emit("error", new Error("Invalid qos vector")), !1;
                  p += 1
                }
              }
              var b = null;
          ...
          case "auth":
            return function(e, t, r) {
              ...
              var l = j(t, u, r, c);
              if (!l) return !1;
              c += l.length, t.write(o.from([i.codes.auth << 4])), v(t, c), t.write(o.from([a])), null !== l && l.write();
              return !0
            }(t, r, n);
          default:
    ...
    93: [function(t, r, n) {
      (function(t) {
        ! function(i) {
          var o = "object" == e(n) && n && !n.nodeType && n,
            s = "object" == e(r) && r && !r.nodeType && r,
            a = "object" == e(t) && t;
          a.global !== a && a.window !== a && a.self !== a || (i = a);
          var u, c, l = 2147483647,
            f = /^xn--/,
            h = /[^\x20-\x7E]/,
            p = /[\x2E\u3002\uFF0E\uFF61]/g,
            d = {
          ...
          function E(e) {
            var t, r, n, i, o, s, a, u, c, f, h, p = [],
              d = e.length,
              b = 0,
              _ = 128,
              m = 72;
            for ((r = e.lastIndexOf("-")) < 0 && (r = 0), n = 0; n < r; ++n) e.charCodeAt(n) >= 128 && y("not-basic"), p.push(e.charCodeAt(n));
            for (i = r > 0 ? r + 1 : 0; i < d;) {
              for (o = b, s = 1, a = 36; i >= d && y("invalid-input"), ((u = (h = e.charCodeAt(i++)) - 48 < 10 ? h - 22 : h - 65 < 26 ? h - 65 : h - 97 < 26 ? h - 97 : 36) >= 36 || u > g((l - b) / s)) && y("overflow"), b += u * s, !(u < (c = a <= m ? 1 : a >= m + 26 ? 26 : a - m)); a += 36) s > g(l / (f = 36 - c)) && y("overflow"), s *= f;
              m = x(b - o, t = p.length + 1, 0 == o), g(b / t) > l - _ && y("overflow"), _ += g(b / t), b %= t, p.splice(b++, 0, _)
            }
            return w(p)
          }
          ...
          function k(e) {
            ...
            for (n = i = w.length, i && w.push("-"); n < p;) {
              ...
              for (a - t > g((l - r) / (d = n + 1)) && y("overflow"), r += (a - t) * d, t = a, s = 0; s < p; ++s)
                if ((h = e[s]) < t && ++r > l && y("overflow"), h == t) {
                  for (u = r, c = 36; !(u < (f = c <= o ? 1 : c >= o + 26 ? 26 : c - o)); c += 36) m = u - f, _ = 36 - f, w.push(b(S(f + m % _, 0))), u = g(m / _);
      ...
      (function(r, n) {
        ...
        function v(e, t, r, n, i) {
          ...
          null === t ? (s.reading = !1, function(e, t) {
            ...
            return c.from(e)
          }(t)), n ? s.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : w(e, s, t, !0) : s.ended ? e.emit("error", new Error("stream.push() after EOF")) : (s.reading = !1, s.decoder && !r ? (t = s.decoder.write(t), s.objectMode || 0 !== t.length ? w(e, s, t, !1) : k(e, s)) : w(e, s, t, !1))) : n || (s.reading = !1));
          return function(e) {
        ...
        function w(e, t, r, n) {
          t.flowing && 0 === t.length && !t.sync ? (e.emit("data", r), e.read(0)) : (t.length += t.objectMode ? 1 : r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && x(e)), k(e, t)
        }
        ...
        m.prototype.read = function(e) {
          ...
          var t = this._readableState,
            r = e;
          if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return p("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? P(this) : x(this), null;
          ...
          function c(t, r) {
            p("onunpipe"), t === n && r && !1 === r.hasUnpiped && (r.hasUnpiped = !0, p("cleanup"), e.removeListener("close", y), e.removeListener("finish", _), e.removeListener("drain", f), e.removeListener("error", b), e.removeListener("unpipe", c), n.removeListener("end", l), n.removeListener("end", m), n.removeListener("data", g), h = !0, !o.awaitDrain || e._writableState && !e._writableState.needDrain || f())
          }
          ...
          function g(t) {
            p("ondata"), d = !1, !1 !== e.write(t) || d || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== M(o.pipes, e)) && !h && (p("false write response, pause", n._readableState.awaitDrain), n._readableState.awaitDrain++, d = !0), n.pause())
          }
          ...
          return n.on("data", g),
            ...
            }(e, "error", b), e.once("close", y), e.once("finish", _), e.emit("pipe", n), o.flowing || (p("pipe resume"), n.resume()), e
      ...
      (function(r, n, i) {
        ...
        function w(e, t) {
          ...
          if (e._writev && r && r.next) {
            ...
            i.allBuffers = u, m(e, t, !0, t.length, i, "", o.finish), t.pendingcb++, t.lastBufferedRequest = null, o.next ? (t.corkedRequestsFree = o.next, o.next = null) : t.corkedRequestsFree = new s(t), t.bufferedRequestCount = 0
          } else {
            for (; r;) {
              var c = r.chunk,
                l = r.encoding,
    ...
    113: [function(t, r, n) {
      ...
      s.prototype.parse = function(t, r, n) {
        ...
        if (v = v.trim(), !n && 1 === t.split("#").length) {
          var w = c.exec(v);
          if (w) return this.path = v, this.href = v, this.pathname = w[1], w[2] ? (this.search = w[2], this.query = r ? m.parse(this.search.substr(1)) : this.search.substr(1)) : r && (this.search = "", this.query = {}), this
        }
        var S = a.exec(v);
        if (S) {
        ...
        if (!y[S] && (E || S && !_[S])) {
          ...
          } - 1 !== (I = -1 === O ? v.lastIndexOf("@") : v.lastIndexOf("@", O)) && (k = v.slice(0, I), v = v.slice(I + 1), this.auth = decodeURIComponent(k)), O = -1;
          for (j = 0; j < h.length; j++) {
            var T; - 1 !== (T = v.indexOf(h[j])) && (-1 === O || T < O) && (O = T)
          ...
          var D = this.port ? ":" + this.port : "",
            F = this.hostname || "";
          this.host = F + D, this.href += this.host, A && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== v[0] && (v = "/" + v))
        }
        if (!b[x])
          for (j = 0, C = f.length; j < C; j++) {
            var z = f[j];
            if (-1 !== v.indexOf(z)) {
        ...
        var K = v.indexOf("#"); - 1 !== K && (this.hash = v.substr(K), v = v.slice(0, K));
        var H = v.indexOf("?");
        if (-1 !== H ? (this.search = v.substr(H), this.query = v.substr(H + 1), r && (this.query = m.parse(this.query)), v = v.slice(0, H)) : r && (this.search = "", this.query = {}), v && (this.pathname = v), _[x] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
          D = this.pathname || "";
          var V = this.search || "";
          this.path = D + V
        }
        ...
        var t = this.protocol || "",
          ...
          i = !1,
          s = "";
        this.host ? i = e + this.host : this.hostname && (i = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (i += ":" + this.port)), this.query && o.isObject(this.query) && Object.keys(this.query).length && (s = m.stringify(this.query));
        var a = this.search || s && "?" + s || "";
        return t && ":" !== t.substr(-1) && (t += ":"), this.slashes || (!t || _[t]) && !1 !== i ? (i = "//" + (i || ""), r && "/" !== r.charAt(0) && (r = "/" + r)) : i || (i = ""), n && "#" !== n.charAt(0) && (n = "#" + n), a && "?" !== a.charAt(0) && (a = "?" + a), t + i + (r = r.replace(/[?#]/g, (function(e) {
        ...
        var m = r.pathname && "/" === r.pathname.charAt(0),
          ...
          w = v || m || r.host && e.pathname,
          S = w,
          x = r.pathname && r.pathname.split("/") || [],
          E = (d = e.pathname && e.pathname.split("/") || [], r.protocol && !_[r.protocol]);
        if (E && (r.hostname = "", r.port = null, r.host && ("" === x[0] ? x[0] = r.host : x.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), w = w && ("" === d[0] || "" === x[0])), v) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, x = d;
        else if (d.length) x || (x = []), x.pop(), x = x.concat(d), r.search = e.search, r.query = e.query;
        else if (!o.isNullOrUndefined(e.search)) {
          if (E) r.hostname = r.host = x.shift(), (T = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = T.shift(), r.host = r.hostname = T.shift());
        ...
        for (var k = x.slice(-1)[0], I = (r.host || e.host || x.length > 1) && ("." === k || ".." === k) || "" === k, O = 0, j = x.length; j >= 0; j--) "." === (k = x[j]) ? x.splice(j, 1) : ".." === k ? (x.splice(j, 1), O++) : O && (x.splice(j, 1), O--);
        if (!w && !S)
          for (; O--; O) x.unshift("..");
        !w || "" === x[0] || x[0] && "/" === x[0].charAt(0) || x.unshift(""), I && "/" !== x.join("/").substr(-1) && x.push("");
        var T, A = "" === x[0] || x[0] && "/" === x[0].charAt(0);
        E && (r.hostname = r.host = A ? "" : x.length ? x.shift() : "", (T = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = T.shift(), r.host = r.hostname = T.shift()));
        return (w = w || r.host && x.length) && !A && x.unshift(""), x.length ? r.pathname = x.join("/") : (r.pathname = null, r.path = null), o.isNull(r.pathname) && o.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r
    ...
    117: [function(t, r, n) {
      (function(r, i) {
        ...
        function u(e, t) {
          ...
          return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), g(t) ? r.showHidden = t : t && n._extend(r, t), m(r.showHidden) && (r.showHidden = !1), m(r.depth) && (r.depth = 2), m(r.colors) && (r.colors = !1), m(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = c), f(r, e, r.depth)
        }
        ...
        function f(e, t, r) {
          ...
          return v(t) && (l = " " + RegExp.prototype.toString.call(t)), S(t) && (l = " " + Date.prototype.toUTCString.call(t)), x(t) && (l = " " + h(t)), 0 !== s.length || w && 0 != t.length ? r < 0 ? v(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(t), c = w ? function(e, t, r, n, i) {
        ...
        function p(e, t, r, n, i, o) {
          ...
          if ((u = Object.getOwnPropertyDescriptor(t, i) || {
              value: t[i]
            }).get ? a = u.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : u.set && (a = e.stylize("[Setter]", "special")), T(n, i) || (s = "[" + i + "]"), a || (e.seen.indexOf(u.value) < 0 ? (a = b(r) ? f(e, u.value, null) : f(e, u.value, r - 1)).indexOf("\n") > -1 && (a = o ? a.split("\n").map((function(e) {
              return "  " + e
            })).join("\n").substr(2) : "\n" + a.split("\n").map((function(e) {
              return "   " + e
        ...
        n.debuglog = function(e) {
          if (m(s) && (s = r.env.NODE_DEBUG || ""), e = e.toUpperCase(), !a[e])
          ...
          return "symbol" === e(t)
        }, n.isUndefined = m, n.isRegExp = v, n.isObject = w, n.isDate = S, n.isError = x, n.isFunction = E, n.isPrimitive = function(t) {
          return null === t || "boolean" == typeof t || "number" == typeof t || "string" == typeof t || "symbol" === e(t) || void 0 === t
    ...
    118: [function(t, r, n) {
      (function(n, i) {
        var o = t("readable-stream").Transform,
          s = t("duplexify"),
          a = t("ws"),
          u = t("safe-buffer").Buffer;
        r.exports = function(t, r, c) {
          var l, f, h = "browser" === n.title,
            p = !!i.WebSocket,
          ...
          var b = c.browserBufferSize || 524288,
